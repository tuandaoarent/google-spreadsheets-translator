...
const languages = [
  ...
  { code: 'us', name: 'English', codeDisplay: '🇺🇸' },
  { code: 'fr', name: 'French', codeDisplay: '🇫🇷' },
  { code: 'de', name: 'German', codeDisplay: '🇩🇪' },
  { code: 'it', name: 'Italian', codeDisplay: '🇮🇹' },
  { code: 'es', name: 'Spanish', codeDisplay: '🇪🇸' },
  { code: 'za', name: 'Afrikaans', codeDisplay: '' },
  { code: 'al', name: 'Albanian', codeDisplay: '🇦🇱' },
  { code: 'sa', name: 'Arabic', codeDisplay: '🇸🇦' },
  { code: 'az', name: 'Azerbaijani', codeDisplay: '🇦🇿' },
  { code: 'es', name: 'Basque', codeDisplay: '' },
  { code: 'bd', name: 'Bengali', codeDisplay: '' },
  { code: 'by', name: 'Belarusian', codeDisplay: '🇧🇾' },
  { code: 'bg', name: 'Bulgarian', codeDisplay: '🇧🇬' },
  { code: 'mm', name: 'Burmese', codeDisplay: '🇲🇲' },
  { code: 'es', name: 'Catalan', codeDisplay: '' },
  { code: 'cn', name: 'Chinese (Simplified)', codeDisplay: '🇨🇳' },
  { code: 'tw', name: 'Chinese (Traditional)', codeDisplay: '🇹🇼' },
  { code: 'hr', name: 'Croatian', codeDisplay: '🇭🇷' },
  { code: 'cz', name: 'Czech', codeDisplay: '🇨🇿' },
  { code: 'dk', name: 'Danish', codeDisplay: '🇩🇰' },
  { code: 'nl', name: 'Dutch', codeDisplay: '🇳🇱' },
  { code: 'ee', name: 'Estonian', codeDisplay: '🇪🇪' },
  { code: 'fi', name: 'Finnish', codeDisplay: '🇫🇮' },
  { code: 'gr', name: 'Greek', codeDisplay: '🇬🇷' },
  { code: 'il', name: 'Hebrew', codeDisplay: '🇮🇱' },
  { code: 'in', name: 'Hindi', codeDisplay: '🇮🇳' },
  { code: 'hu', name: 'Hungarian', codeDisplay: '🇭🇺' },
  { code: 'is', name: 'Icelandic', codeDisplay: '🇮🇸' },
  { code: 'id', name: 'Indonesian', codeDisplay: '🇮🇩' },
  { code: 'ie', name: 'Irish', codeDisplay: '🇮🇪' },
  { code: 'jp', name: 'Japanese', codeDisplay: '🇯🇵' },
  { code: 'kr', name: 'Korean', codeDisplay: '🇰🇷' },
  { code: 'lv', name: 'Latvian', codeDisplay: '🇱🇻' },
  { code: 'lt', name: 'Lithuanian', codeDisplay: '🇱🇹' },
  { code: 'mk', name: 'Macedonian', codeDisplay: '🇲🇰' },
  { code: 'my', name: 'Malay', codeDisplay: '🇲🇾' },
  { code: 'mt', name: 'Maltese', codeDisplay: '🇲🇹' },
  { code: 'no', name: 'Norwegian', codeDisplay: '🇳🇴' },
  { code: 'ir', name: 'Persian', codeDisplay: '🇮🇷' },
  { code: 'pl', name: 'Polish', codeDisplay: '🇵🇱' },
  { code: 'pt', name: 'Portuguese', codeDisplay: '🇵🇹' },
  { code: 'ro', name: 'Romanian', codeDisplay: '🇷🇴' },
  { code: 'ru', name: 'Russian', codeDisplay: '🇷🇺' },
  { code: 'rs', name: 'Serbian', codeDisplay: '🇷🇸' },
  { code: 'sk', name: 'Slovak', codeDisplay: '🇸🇰' },
  { code: 'si', name: 'Slovenian', codeDisplay: '🇸🇮' },
  { code: 'tz', name: 'Swahili', codeDisplay: '🇹🇿' },
  { code: 'se', name: 'Swedish', codeDisplay: '🇸🇪' },
  { code: 'th', name: 'Thai', codeDisplay: '🇹🇭' },
  { code: 'tr', name: 'Turkish', codeDisplay: '🇹🇷' },
  { code: 'ua', name: 'Ukrainian', codeDisplay: '🇺🇦' },
  { code: 'pk', name: 'Urdu', codeDisplay: '🇵🇰' },
  { code: 'vn', name: 'Vietnamese', codeDisplay: '🇻🇳' },
  { code: 'gb', name: 'Welsh', codeDisplay: '🇬🇧' }
];
